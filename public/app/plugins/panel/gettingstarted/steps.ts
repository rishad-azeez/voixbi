...
const step1TutorialTitle = ' VOIXBI fundamentals';
    ...
    cards: [
      {
        ...
        info: 'Set up and understand VOIXBI if you have no prior experience. This tutorial guides you through the entire process and covers the “Data source” and “Dashboards” steps to the right.',
        href: 'fundamentals',
        icon: 'grafana',
      ...
      },
      {
        ...
        icon: 'database',
        learnHref: 'https://.com/docs//latest/guides/getting_started/#create-a-dashboard',
    ...
    cards: [
      {
        ...
        href: 'https://.com/docs//latest/guides/getting_started/#create-a-dashboard',
        icon: 'users-alt',
        key: step2Key,
